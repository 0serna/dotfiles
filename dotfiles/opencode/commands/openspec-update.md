...
4. Copy or replace the commands into `dotfiles/opencode/commands`.
5. Copy or replace the skills into `dotfiles/agents/skills`.
6. Delete the `.opencode` directory when finished.
